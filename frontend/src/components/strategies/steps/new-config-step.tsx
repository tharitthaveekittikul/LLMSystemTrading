...
import type { CreateStrategyPayload, StrategyRegistryEntry } from "@/types/trading";

interface NewConfigStepProps {
  form: CreateStrategyPayload;
  setForm: React.Dispatch<React.SetStateAction<CreateStrategyPayload>>;
  isLlmMode: boolean;
            ...
            <div className="space-y-1.5">
              ...
              {loadingModels ? (
                ...
                <ModelSelector
                  ...
                  onValueChange={(v) =>
                    setForm((f) => ({ ...f, llm_model: v || undefined }))
                  }
                  models={modelOptions}
