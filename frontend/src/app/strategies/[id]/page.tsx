...
export default function StrategyDetailPage() {
  ...
  async function handleToggleBinding(binding: StrategyBinding) {
    const updated = await strategiesApi.toggleBinding(
      strategyId,
      binding.account_id,
      !binding.is_active,
    );
  ...
  if (!strategy)
    return (
      <SidebarInset>
        <AppHeader title="Strategy" />
        <div className="p-4 text-muted-foreground">Strategy not found.</div>
      </SidebarInset>
    );
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Badge variant="outline">
                {strategy.trigger_type === "candle_close"
                  ? "Candle close"
                  : `Every ${strategy.interval_minutes}m`}
              </Badge>
            </div>
            <Switch
                ...
                {bindings.map((b) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Switch
                        checked={b.is_active}
                        onCheckedChange={() => handleToggleBinding(b)}
                      />
                      <Button
                        variant="outline"
                        size="sm"
